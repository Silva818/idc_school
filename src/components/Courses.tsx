      ...
      <div className="mx-auto max-w-container px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col gap-4 mb-8 sm:mb-10">
          ...
          <div className="max-w-3xl">
            <h2 id="courses-top" className="text-3xl sm:text-3xl lg:text-4xl font-semibold tracking-tight mb-3 scroll-mt-[calc(var(--header-h,96px)-36px)] md:scroll-mt-[var(--header-h,96px)]">
              {t("title")}
            </h2>
